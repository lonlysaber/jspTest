		...
		<div class="container">
			...
			<h1>No Order Found.</h1>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td class="cart_total">
						<%
							com.zhangjinzhe.model.Order o=(com.zhangjinzhe.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.zhangjinzhe.model.Payment.findByPaymentId(con,n);
							 %>
